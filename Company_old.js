...
var bmw = new company('BMW', 'aa@aa.com', '346-222-3331', 'BMW', 'Park street', 'Phoenix', 'Arizona', 'USA', 'DUNS1', 'Supplier');
var mercedes = new company('Berkleey', 'bb@bb.com', '346-222-3332', 'Mercedes', 'Salt Street', 'Dallas', 'Texas', 'USA', 'DUNS2', 'Buyer');
var toyota = new company('Toyota', 'Toyota@gmail.com', '346-222-3333', 'Toyota', 'lake street', 'Houston', 'Texas', 'USA', 'DUNS3', 'Supplier');
var chevrolet = new company('Chevrolet', 'Chevrolet@gmail.com', '346-222-3334', 'Chevrolet', 'Down street', 'Colorado', 'Denver', 'USA', 'DUNS4', 'Supplier');
...
var zoomCar = new company('Zoom Car', 'Dodge@gmail.com', '346-222-3339', 'Dodge', 'Elm  street', 'New Jersey', 'New York', 'USA', 'DUNS9', 'Buyer');
...
var goodyear = new company('Good Year', 'cc@cc.com', '346-222-3335', 'Goodyear', 'Bay street', 'Georgia', 'Atlanta', 'USA', 'DUNS5', 'Supplier');
...
var acura = new company('Acura', 'acura@gmail.com', '346-222-3330', 'Acura', 'Cedar street', 'Missouri', 'Kansas City', 'USA', 'DUNS10', 'Buyer');
...
var companyList = [bmw, mercedes, toyota, chevrolet, nissan, volvo, honda, buick, zoomCar, uber, ford, americanloco, denso, towerAutomotive, gmc, genuineParts, tenneco, lear, hyundai, carlsson, lexus, mazda, suzuki, fiat, audi, linamar, nipresspt, goodyear, mrf, exide, dunlop, bosch, ceat, ferrari, tesla, subaru, kia, landrover, volksWagen,
    ...
    geely, opel, acura, mahindra, hino, lincon, baic, tvs, yamaha, magna, dodge, jac, tatamotors, berklee, clutchAuto, goodwayMachine,
...
function renderCompany(companyList) {
    ...
    for (var i = 0; i < companyList.length; i++) {
        if (seltype == 'SupplierAdmin' || seltype == 'Supplier') {
            if (companyList[i].type == 'Buyer' || companyList[i].name == cmpName) {
                ...
                if (seltype == 'SupplierAdmin' || seltype == 'BuyerAdmin' || seltype == 'Buyer' || seltype == 'Supplier') {
